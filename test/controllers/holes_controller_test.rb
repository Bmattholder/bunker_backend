...
class HolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hole" do
    assert_difference('Hole.count') do
      post holes_url, params: { hole: { number: @hole.number, par: @hole.par, yardage: @hole.yardage } }, as: :json
    end
  ...
  test "should update hole" do
    patch hole_url(@hole), params: { hole: { number: @hole.number, par: @hole.par, yardage: @hole.yardage } }, as: :json
    assert_response 200
  end
